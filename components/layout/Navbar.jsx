...
<div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8">
      <div className="relative flex items-center justify-between">
        ...
        >
          ...
          <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase cursor-pointer">
            FLINT
          </span>
        ...
        {navigation.map(({ name, href }) => (
           <li key={name}>
            <Link
              ...
              title="Our product"
              className="font-medium tracking-wide text-gray-700 transition-colors duration-200 cursor-pointer hover:text-deep-purple-accent-400"
            >
              {name}
            </Link>
          </li>
